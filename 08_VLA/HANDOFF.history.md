# HANDOFF history — site
*Superseded / per-task sections moved verbatim out of `HANDOFF.md` on 2026-09-25 (nothing deleted). Newest first. Not live state — read `HANDOFF.md` for that.*

## Wave 3 of the CoRe rename (closed; moved from HANDOFF.md)
...
## Per-task status notes (moved from "Current status")
...
### Key numbers as of 2026-09-22 (verbatim)
