...
## 4. Git
- Repo `/home/yanggon/0007_26summer/versel_distribute`, remote `origin git@github.com:yanggon-kim/versel_distribute.git`, branch `main` tracking `origin/main`. No `.gitignore`, no `vercel.json`. `ONBOARDING.md` / `HANDOFF.md` (and their `.history.md`) are tracked.
